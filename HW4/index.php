...
$works = [
    [
        ...
        "description" => "Создание мобильных и компьютерных приложений, игр, баз данных 
        и прочего программного обеспечения самых различных устройств. ",
    ],
    [
        "name" => "Аналитик",
        "dateStart" => "Февраль 2020",
        "dateEnd" => "Февраль 2022",
        "description" => "Сбор, обработка и сегментирование больших объёмов данных,
         их анализ и представление выводов в понятном виде. ",
    ],
    [
        "name" => "Тестировщик",
        "dateStart" => "Февраль 2015",
        "dateEnd" => "Февраль 2018",
        "description" => "Выявление и устранение ошибок в программном обеспечении. 
        Тестировать программы, проверять и отлаживать код, улучшать юзабилити, то есть, 
